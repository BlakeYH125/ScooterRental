...
* **src/.../app** - основной пакет, содержит конфигурацию Spring Boot, входную точку в приложение и интеграционные тесты.
* **src/.../controller** - содержит REST-контроллеры для обработки HTTP-запросов, а также перехватчик исключений.
* **src/.../model** - содержит сущности, перечисления и исключения.
* **src/.../repository** - содержит интерфейсы DAO и их реализацию с использованием Hibernate.
* **src/.../service** - содержит бизнес-логику системы, DTO-классы и MapStruct-мапперы.
...
Система будет доступна по адресу: http://localhost:8080/scooter-rental
